...
if Request.QueryString("action") = "add" then
   ...
   event_context = Request.QueryString("event_context")
	...
	event_location = rsEvents("event_location")
...
query = "SELECT * FROM ext_cal_context ORDER BY name"
...
<form method="post" action="ext_cal_edited.asp">
...
<tr>
	...
	<td colspan=2>
	<input type="text" name="event_location" value="<%=event_location%>" size=45>
	</td>
<tr>
	<td align="right" <%=light%>>
	<font face="arial" size=2>Description</font></td>
	<td colspan=2>
	<textarea name="event_description" cols=40 rows=5 wrap="virtual"><%=event_description%></textarea>
	</td>
<tr>
	<td align="right" <%=light%>>
